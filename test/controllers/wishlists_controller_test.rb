...
class WishlistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wishlist" do
    assert_difference('Wishlist.count') do
      post wishlists_url, params: { wishlist: { description: @wishlist.description, name: @wishlist.name, picture: @wishlist.picture, price: @wishlist.price, priority: @wishlist.priority } }
    end
  ...
  test "should update wishlist" do
    patch wishlist_url(@wishlist), params: { wishlist: { description: @wishlist.description, name: @wishlist.name, picture: @wishlist.picture, price: @wishlist.price, priority: @wishlist.priority } }
